...
<div class="row">
	...
	<div class="col-md-8">
		...
		<div class="panel panel-gradient" data-collapsed="0">
			...
			<div class="panel-heading">
				<div class="panel-title">
					 <?php echo $this->cname; ?> County Reporting Form.
				</div>
			...
			<div class="panel-body">
				 <form name="generate" class="TTWForm" method="POST" action="<?php echo base_url("mpdf/d_rep");?>" >
			    <table  class='table table-bordered'   >
	  	 
		<input type="hidden" name="countycode" value="<?php echo $this->countyID; ?>" />
		<input type="hidden" name="countyname"  value="<?php echo $this->cname; ?> County" />
		</tr>
		...
		<td style="text-align:left" >  
		<div class="col-md-6"><select name="facility" id="facility" class="form-control">
    ...
    Duration/Periods: 
		...
		<div  align="center" class="my-div me_1" style="DISPLAY: none" >
            <div class="col-md-4">Month:<select  class="form-control" name="monthly" >
   ...
   <div class="col-md-4"> To:<div class="input-group">
    ...
    <div  align="center" class="my-div me_5" style="DISPLAY: none" >
     <div class="col-md-4"> Select Date:<div class="input-group">
		<input class="form-control datepicker" type="text" data-format="yyyy-mm-d" id="specificdate" name="specificdate" >
		<div class="input-group-addon">
		<a href="#">
		<i class="entypo-calendar"></i>
		</a>

...
class changePass_dltc extends MY_Controller {
...
public function index(){
			...
			$this->changePass_dltc();
			
			
			
		}

		public function changePass_dltc(){
         ...
         //    $data['minY'] = $this->get_min_year();
			...
			$this->load->load_dtlc_changePass('dtlc/changePass_dltc_v',$data);	

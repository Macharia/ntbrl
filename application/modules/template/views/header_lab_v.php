...
<div class="sidebar-menu fixed" style="width: 245px;">
	<ul id="main-menu" style="margin-top: 52%;">
		   <li style="font-size: 10px;">
		      <a href="<?php echo base_url('labtech/sample1'); ?>"><i class="entypo-user-add"></i><span>Add Patient Details</span></a>
		   </li>
		   <li style="font-size: 10px;">
		      <a href="<?php echo base_url('labtech/worksheet'); ?>"><i class="entypo-docs"></i><span>View Worksheet</span><span class="badge badge-info"><?php echo $notup ?></span></a>
		   </li>
		  <!-- <li style="font-size: 10px;">
		   ...
		   <li style="font-size: 10px;">
			 <a href="<?php echo base_url('labtech/changePass'); ?>"><i class="entypo-user"></i><span>Change Password</span></a>
		   </li>
		   <li style="font-size: 10px;">

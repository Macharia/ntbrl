	...
	<!-- TS1387507087: Neon - Responsive <?php echo base_url(); ?>admin Template created by Laborator -->
		...
		<div class="panel panel-gradient" data-collapsed="0">
			...
			<div class="panel-heading">
				<div class="panel-title">
					Inventory of all facilities in the country
				</div>
			...
			<div class="panel-body">
				<div id="invdiv"> 
				    <script type="text/javascript">
					   	var myChart = new FusionCharts("<?php echo base_url(); ?>assets/FusionCharts/Charts/Bar2D.swf", "myChartnat", "1270", "900", "0", "0");

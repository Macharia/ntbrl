...
<div class="row">
		...
		<div class="panel panel-gradient" data-collapsed="0">
			...
			<div class="panel-heading">
				<div class="panel-title">
					<?php echo  $this->session->userdata('name');?> Reporting Form.
				</div>
			...
			<div class="panel-body">
				 <form name="generate" class="TTWForm" method="POST" action="<?php echo base_url(); ?>mpdf/rep" >
			    <table  class='table table-bordered'>
	  	 
		<input type="hidden" name="mfl" value="<?php echo  $this->session->userdata('mfl');?>" />
		<input type="hidden" name="fn" value="<?php echo  $this->session->userdata('name');?>" />
		</tr>
    ...
    Duration/Periods: 
		...
		<div  align="center" class="my-div me_1" style="DISPLAY: none" >
			...
			<?php
			$years = range ($this->maxY,$this->minY); 

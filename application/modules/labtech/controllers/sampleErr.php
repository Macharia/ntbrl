...
class sampleErr extends MY_Controller {
...
public function index(){
			...
			$this->index_sampleErr();
			
			
			
		}

		public function index_sampleErr(){
			...
			$this->load->load_lab_sampleErr('labtech/sampleErr_v',$data);	
		...
		public function get_sample_Err(){

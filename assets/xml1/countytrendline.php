...
$startmonth =  1; 
 $endmonth =  12; 
		...
		$totaltests=getCountytestsdone($countyID,$startmonth,2013);
...
$startmonth =  1; 
 $endmonth =  12;
		...
		$mtbpos=getCountymtbpos($countyID,$startmonth,2013);
...
$startmonth =  1; 
 $endmonth =  12; 
		...
		$mtbneg=getCountymtbneg($countyID,$startmonth,2013);
...
$startmonth =  1; 
 $endmonth =  12; 
		...
		$mtbrif=getCountymtbrif($countyID,$startmonth,2013);
